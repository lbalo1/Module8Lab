...
{
    // Attributes - these are varibles that hold values 
    public int Id { get; set; }
    // Adding a ? to make the attribute nullable
...
// Pokemon link lab class contains are main method
...
public class PokemonLinqLab
{
    public static void Main()
    {
        ...
        // Linq query: Find Pokemant that are ready to evolve
